...
(deftest find-commands
  (testing "Basic cases"
    ...
    (is (= #{(cm/command-map-path [] #'commando-registry/default-command-map-spec)
             (cm/command-map-path [:some-val] #'commando-registry/default-command-map-spec)
             (cm/command-map-path [:some-other] #'commando-registry/default-command-value-spec)
             (cm/command-map-path [:my-value] #'commando-registry/default-command-value-spec)
             (cm/command-map-path [:i] #'commando-registry/default-command-map-spec)
             (cm/command-map-path [:v] #'commando-registry/default-command-vec-spec)
    ...
    (is (= #{(cm/command-map-path [] #'commando-registry/default-command-map-spec)
             (cm/command-map-path [:set] #'commando-registry/default-command-value-spec)
    ...
    (is (=
          #{(cm/command-map-path [] #'commando-registry/default-command-map-spec)
            (cm/command-map-path [:a] #'commando-registry/default-command-map-spec)
            (cm/command-map-path [:target] #'commando-registry/default-command-value-spec)
            (cm/command-map-path [:a "some"] #'commando-registry/default-command-map-spec)
